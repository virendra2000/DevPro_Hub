        ...
        <>
            <section className="p-5 h-auto bg-slate-100 dark:bg-slate-800 flex flex-col items-center justify-center w-full" id="about">
                <div className="domain-container w-full flex flex-col items-center justify-center">
                    <h1 className="head3 p-2 text-black dark:text-white text-4xl font-bold">My <span className="text-blue-600 dark:text-yellow-300">Domain</span></h1>

                    <div className="mt-5 w-full p-5 flex flex-row items-center justify-between">
                        <div className="card p-5 bg-white dark:bg-slate-700 h-[70vh] w-[30%] rounded-lg flex flex-col items-center justify-center text-center border-0 hover:border-2 hover:border-orange-500 hover:dark:border-white shadow-lg shadow-slate-400 dark:shadow-black">
                            ...
                            <h1 className="text-2xl font-bold text-black dark:text-white">Web Development</h1>
                        ...
                        <div className="card p-5 bg-white dark:bg-slate-700 h-[70vh] w-[30%] rounded-lg flex flex-col items-center justify-center text-center border-0 hover:border-2 hover:border-orange-500 hover:dark:border-white shadow-lg shadow-slate-400 dark:shadow-black">
                            ...
                            <h1 className="text-2xl font-bold text-black dark:text-white">Data Science and Machine Learning</h1>
                        ...
                        <div className="card p-5 bg-white dark:bg-slate-700 h-[70vh] w-[30%] rounded-lg flex flex-col items-center justify-center text-center border-0 hover:border-2 hover:border-orange-500 hover:dark:border-white shadow-lg shadow-slate-400 dark:shadow-black">
                            ...
                            <h1 className="text-2xl font-bold text-black dark:text-white">Python Developer</h1>
